import define1 from "./8a0c9b68af37d7ca@3083.js";
import define2 from "./13e1d08a1a1ed038@3590.js";
...
md`# GESI Survey | Styling

This exposes a method to take the survey information and wrap it in HTML for display.
`
)}
...
function _12(loadStyles,brandConfig,md)
{
...
function _21(exampleSurvey){return(
exampleSurvey
)}
...
function _26(header,d3,layout,surveyConfig){return(
...
function _29(pageMenu,d3,layout,surveyConfig){return(
...
(dom = document) => {
  ...
  if (document.question) {
    ...
    // document.querySelector(`#${document.question}`).scrollIntoView()
...
async function _images(FileAttachment){return(
{
...
function _42(sectionViewExample){return(
sectionViewExample
)}

function _sectionsView(createQuestion,sectionView,bindLogic,view){return(
...
function _exampleSectionView(sectionView,surveyConfig,questions,createQuestion,d3,layout){return(
sectionView(surveyConfig, 
  new Map([...questions.entries()].map(([id, q]) => [id, createQuestion(q)])), 
  d3.group(layout.data, d => d['menu']),
  "extended_survey/internal_operations")
)}

function _45(exampleSectionView){return(
exampleSectionView
)}
...
function _60(substratum,invalidation){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["viewof manualCredentials"], _3);
  main.variable(observer()).define(["saveCreds"], _4);
  main.variable(observer()).define(["md"], _5);
  main.variable(observer()).define(["viewof survey"], _6);
  ...
  main.variable(observer()).define(["loadStyles","brandConfig","md"], _12);
  ...
  main.variable(observer()).define(["exampleSurvey"], _21);
  ...
  main.variable(observer()).define(["header","d3","layout","surveyConfig"], _26);
  main.variable(observer("header")).define("header", ["html","pageHeader","pageMenu"], _header);
  main.variable(observer()).define(["md"], _28);
  main.variable(observer()).define(["pageMenu","d3","layout","surveyConfig"], _29);
  ...
  main.variable(observer()).define(["d3","layout"], _36);
  ...
  main.variable(observer()).define(["sectionViewExample"], _42);
  main.variable(observer("sectionsView")).define("sectionsView", ["createQuestion","sectionView","bindLogic","view"], _sectionsView);
  main.variable(observer("viewof exampleSectionView")).define("viewof exampleSectionView", ["sectionView","surveyConfig","questions","createQuestion","d3","layout"], _exampleSectionView);
  main.variable(observer("exampleSectionView")).define("exampleSectionView", ["Generators", "viewof exampleSectionView"], (G, _) => G.input(_));
  main.variable(observer()).define(["exampleSectionView"], _45);
  ...
  main.variable(observer()).define(["questions"], _48);
  ...
  main.variable(observer()).define(["substratum","invalidation"], _60);
  return main;
}
