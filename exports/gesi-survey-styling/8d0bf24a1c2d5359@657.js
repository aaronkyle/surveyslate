...
import define2 from "./bad810ff1e80611b@137.js";
...
function _tachyons(loadStyles){return(
loadStyles
)}

function _loadStyles(invalidation,defaultOptions,tachyonsVersion,html,cssVariables,scrollUtils,spaceBetweenUtils,trackedUtils,positionUtils,boxShadowUtils,colorUtils,fontUtils)
{
...
function _45(substratum,invalidation){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("tachyons")).define("tachyons", ["loadStyles"], _tachyons);
  main.variable(observer("loadStyles")).define("loadStyles", ["invalidation","defaultOptions","tachyonsVersion","html","cssVariables","scrollUtils","spaceBetweenUtils","trackedUtils","positionUtils","boxShadowUtils","colorUtils","fontUtils"], _loadStyles);
  ...
  main.import("substratum", child2);
  main.variable(observer()).define(["substratum","invalidation"], _45);
  return main;
}
