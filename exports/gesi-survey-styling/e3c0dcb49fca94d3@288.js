// https://observablehq.com/@a10k/hello-json-editor@288
function _1(md){return(
md`# Hello json-editor
Ref.: https://github.com/json-editor/json-editor`
)}

function _example(editor,exampleSchema){return(
editor(exampleSchema, {
  theme: "spectre",
...
function _exampleSchema(){return(
{
  title: "Person",
  type: "object",
  required: [
...
function _editor(html,JSONEditor){return(
...
async function _JSONEditor(require){return(
(await require("@json-editor/json-editor@2.5.4")).JSONEditor
)}

export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("viewof example")).define("viewof example", ["editor","exampleSchema"], _example);
  ...
  main.variable(observer("exampleSchema")).define("exampleSchema", _exampleSchema);
  main.variable(observer()).define(["md"], _5);
  main.variable(observer("editor")).define("editor", ["html","JSONEditor"], _editor);
  main.variable(observer("JSONEditor")).define("JSONEditor", ["require"], _JSONEditor);
  return main;
}
