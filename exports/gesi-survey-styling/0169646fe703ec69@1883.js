...
import define5 from "./b5327e6e2ddcad75@102.js";
import define6 from "./8d0bf24a1c2d5359@657.js";
import define7 from "./6a35be87fa9e4ba9@291.js";
...
function _surveyView(d3,view,custom_css,header,sectionsView,pageFooter){return(
...
function _24(exampleSurvey){return(
exampleSurvey
)}
...
function _29(header,d3,layout,surveyConfig){return(
...
function _32(pageMenu,d3,layout,surveyConfig){return(
...
function _46(sectionViewExample){return(
sectionViewExample
)}
...
function _49(exampleSectionView){return(
exampleSectionView
)}
...
function _66(substratum,invalidation){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("surveyView")).define("surveyView", ["d3","view","custom_css","header","sectionsView","pageFooter"], _surveyView);
  ...
  main.variable(observer()).define(["exampleSurvey"], _24);
  ...
  main.variable(observer()).define(["header","d3","layout","surveyConfig"], _29);
  main.variable(observer("header")).define("header", ["html","pageHeader","pageMenu"], _header);
  main.variable(observer()).define(["md"], _31);
  main.variable(observer()).define(["pageMenu","d3","layout","surveyConfig"], _32);
  ...
  main.variable(observer()).define(["d3","layout"], _39);
  ...
  main.variable(observer()).define(["sectionViewExample"], _46);
  ...
  main.variable(observer()).define(["exampleSectionView"], _49);
  ...
  main.variable(observer()).define(["questions"], _52);
  main.variable(observer()).define(["md"], _53);
  main.variable(observer()).define(["initializeStyles"], _54);
  ...
  main.import("tachyonsExt", child6);
  ...
  main.variable(observer()).define(["substratum","invalidation"], _66);
  return main;
}
