...
import define4 from "./3b76f3b1d596b5d5@99.js";
import define5 from "./09005aca321f8a40@662.js";
import define6 from "./c4047069e47f8784@249.js";
import define7 from "./bad810ff1e80611b@137.js";

function _1(md){return(
md`# GESI Survey | Designer UI `
)}
...
function _18(exampleSurveyMetadata){return(
...
function _21(examplePage){return(
examplePage
)}

function _22(Inputs,examplePage){return(
...
function _26(exampleCell){return(
exampleCell
)}

function _27(Inputs,$0){return(
...
function _cell(randomId,types,Inputs,typeUI,view,buttonLabel,connectionsUI){return(
({
  id = randomId(),
  inner = {
    type: "radio",
...
function _33(exampleTypeUI){return(
exampleTypeUI
)}
...
function _35(exampleTypeUIRadio){return(
exampleTypeUIRadio
)}
...
function _43(exampleFallbackUI){return(
exampleFallbackUI
)}
...
function _46(exampleFallbackUIEntries){return(
...
function _51(sampleMdUI){return(
sampleMdUI
)}
...
function _54(FileAttachment){return(
...
function _56(sampleTextUI){return(
sampleTextUI
)}
...
function _60(exampleRadioUI){return(
exampleRadioUI
)}
...
function _64(FileAttachment){return(
...
function _66(exampleCheckboxUI){return(
exampleCheckboxUI
)}
...
function _71(exampleNumberUI){return(
exampleNumberUI
)}
...
function _75(exampleTextareaUI){return(
exampleTextareaUI
)}

function _textareaUI(view,Inputs,descriptionUI){return(
({title, placeholder, description, rows = 4, score = false} = {}) => {
  const attributes =  [
    {
      id: "rows",
      label: "Rows",
...
function _79(exampleFileAttachmentUI){return(
...
function _84(exampleTableUI2){return(
exampleTableUI2
)}
...
({label, counter_group, counter_value, binary} = {}) => {
  return view`<div class="[ cell__section ][ space-y-3 ph2 pb3 ]">
...
function _100(sampleIncludeOptionalAttributesUINoLabel){return(
sampleIncludeOptionalAttributesUINoLabel
)}

function _101(sampleIncludeOptionalAttributesUI){return(
...
function _103(sampleIncludeOptionalAttributesUI3){return(
...
function _107(FileAttachment){return(
...
function _110(exampleConnectionsUI){return(
...
function _115(exampleConnectionRowBuilder){return(
...
function _117(descriptionUI){return(
...
function _121(exampleSettingsCard){return(
exampleSettingsCard
)}
...
function _125(summaryCard){return(
summaryCard('30 questions across 4 pages')
)}

function _126(summaryCard,html,Inputs){return(
...
function _129(inputLabel){return(
...
function _147(substratum,invalidation){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Inputs","viewof exampleSurveyEditor","viewof anotherSurveyEditorData"], _12);
  ...
  main.variable(observer()).define(["exampleSurveyMetadata"], _18);
  ...
  main.variable(observer()).define(["examplePage"], _21);
  main.variable(observer()).define(["Inputs","examplePage"], _22);
  ...
  main.variable(observer()).define(["exampleCell"], _26);
  main.variable(observer()).define(["Inputs","viewof exampleCell"], _27);
  main.variable(observer("cell")).define("cell", ["randomId","types","Inputs","typeUI","view","buttonLabel","connectionsUI"], _cell);
  ...
  main.variable(observer()).define(["typeUI"], _32);
  main.variable(observer()).define(["exampleTypeUI"], _33);
  ...
  main.variable(observer()).define(["exampleTypeUIRadio"], _35);
  ...
  main.variable(observer()).define(_39);
  ...
  main.variable(observer()).define(["exampleFallbackUI"], _43);
  ...
  main.variable(observer()).define(["exampleFallbackUIEntries"], _46);
  ...
  main.variable(observer()).define(["sampleMdUI"], _51);
  main.variable(observer("mdUI")).define("mdUI", ["view","Inputs"], _mdUI);
  main.variable(observer()).define(["md"], _53);
  main.variable(observer()).define(["FileAttachment"], _54);
  ...
  main.variable(observer()).define(["sampleTextUI"], _56);
  ...
  main.variable(observer()).define(["exampleRadioUI"], _60);
  ...
  main.variable(observer()).define(["FileAttachment"], _64);
  ...
  main.variable(observer()).define(["exampleCheckboxUI"], _66);
  ...
  main.variable(observer()).define(["typeUI"], _68);
  ...
  main.variable(observer()).define(["exampleNumberUI"], _71);
  ...
  main.variable(observer()).define(["exampleTextareaUI"], _75);
  ...
  main.variable(observer()).define(["exampleFileAttachmentUI"], _79);
  ...
  main.variable(observer()).define(["exampleTableUI2"], _84);
  ...
  main.variable(observer()).define(["sampleIncludeOptionalAttributesUINoLabel"], _100);
  main.variable(observer()).define(["sampleIncludeOptionalAttributesUI"], _101);
  ...
  main.variable(observer()).define(["sampleIncludeOptionalAttributesUI3"], _103);
  ...
  main.variable(observer()).define(["FileAttachment"], _107);
  ...
  main.variable(observer()).define(["exampleConnectionsUI"], _110);
  ...
  main.variable(observer()).define(["exampleConnectionRowBuilder"], _115);
  main.variable(observer()).define(["md"], _116);
  main.variable(observer()).define(["descriptionUI"], _117);
  ...
  main.variable(observer()).define(["html"], _135);
  ...
  main.variable(observer()).define(["substratum","invalidation"], _147);
  return main;
}
