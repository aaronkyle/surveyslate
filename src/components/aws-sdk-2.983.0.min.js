    ...
    70: [function(e, t, r) {
        ...
        function a(e, t) {
            ...
            s.apply(this, arguments), u && (n(this, "defaultValue", function() {
                ...
                return !1
            }), n(this, "isDocument", Boolean(e.document))), e.members && (n(this, "members", new g(e.members, t, function(e, r) {
            ...
            T.EOF = 0, T.UnquotedIdentifier = 0, T.QuotedIdentifier = 0, T.Rbracket = 0, T.Rparen = 0, T.Comma = 0, T.Rbrace = 0, T.Number = 0, T.Current = 0, T.Expref = 0, T.Pipe = 1, T.Or = 2, T.And = 3, T.EQ = 5, T.GT = 5, T.LT = 5, T.GTE = 5, T.LTE = 5, T.NE = 5, T.Flatten = 9, T.Star = 20, T.Filter = 21, T.Dot = 40, T.Not = 45, T.Lbrace = 50, T.Lbracket = 55, T.Lparen = 60, l.prototype = {
                ...
                _parseMultiselectList: function() {
                    for (var e = [];
                        ...
                        var t = this.expression(0);
                        if (e.push(t),
                            "Comma" === this._lookahead(0) && (this._match("Comma"), "Rbracket" === this._lookahead(0))) throw new Error("Unexpected token Rbracket")
                    }
                    return this._match("Rbracket"), {
        ...
        (function(e) {
            (function() {
                ! function(n) {
                    ...
                    function h(e, t, r) {
                        var n = 0;
                        for (e = r ? N(e / R) : e >> 1, e += N(e / t); e > O * C >> 1; n += _) e = N(e / O);
                    ...
                    function f(e) {
                        ...
                        for (e = a(e), v = e.length, t = T, r = 0, s = A, u = 0; u < v; ++u)(m = e[u]) < 128 && w.push(U(m));
...
AWS.apiLoader.services.cloudfront = {}, AWS.CloudFront = AWS.Service.defineService("cloudfront", ["2016-11-25", "2017-03-25", "2017-10-30", "2018-06-18", "2018-11-05", "2019-03-26", "2020-05-31"]), _xamzrequire = function r(e, t, n) {
    function i(a, u) {
        if (!t[a]) {
            if (!e[a]) {
    ...
    91: [function(r, e, t) {
        var n = r("../core");
        r("../cloudfront/signer"), n.util.update(n.CloudFront.prototype, {
            setupRequestListeners: function(r) {
                r.addListener("extractData", n.util.hoistPayloadMember)
            }
        })
    }, {
        "../cloudfront/signer": 36,
        "../core": 39
    }],
    36: [function(r, e, t) {
        var n = r("../core"),
            ...
            p = function(r, e) {
                var t = o.createSign("RSA-SHA1");
                return t.write(r), c(t.sign(e, "base64"))
            },
            s = function(r, e, t, n) {
                ...
                return {
                    Expires: e,
                    "Key-Pair-Id": t,
                    Signature: p(i.toString(), n)
                }
            },
            l = function(r, e, t) {
                return r = r.replace(/\s/gm, ""), {
                    Policy: c(a(r)),
                    "Key-Pair-Id": e,
                    Signature: p(r, t)
                }
            ...
            f = function(r) {
                var e = r.split("://");
                if (e.length < 2) throw new Error("Invalid URL.");
                return e[0].replace("*", "")
            },
            h = function(r) {
                var e = i.parse(r);
                return e.path.replace(/^\//, "") + (e.hash || "")
            },
            d = function(r) {
                switch (f(r)) {
                    case "http":
            ...
            y = function(r, e) {
                if (!e || "function" != typeof e) throw r;
                e(r)
            },
            v = function(r, e) {
                if (!e || "function" != typeof e) return r;
                e(null, r)
            };
        n.CloudFront.Signer = u({
            constructor: function(r, e) {
                if (void 0 === r || void 0 === e) throw new Error("A key pair ID and private key are required");
                this.keyPairId = r, this.privateKey = e
            },
            getSignedCookie: function(r, e) {
                var t = "policy" in r ? l(r.policy, this.keyPairId, this.privateKey) : s(r.url, r.expires, this.keyPairId, this.privateKey),
                    n = {};
                for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && (n["CloudFront-" + i] = t[i]);
                return v(n, e)
            },
            getSignedUrl: function(r, e) {
                try {
                    var t = d(r.url)
                } catch (r) {
                    return y(r, e)
                }
                var n = i.parse(r.url, !0),
                    o = Object.prototype.hasOwnProperty.call(r, "policy") ? l(r.policy, this.keyPairId, this.privateKey) : s(t, r.expires, this.keyPairId, this.privateKey);
                n.search = null;
                for (var a in o) Object.prototype.hasOwnProperty.call(o, a) && (n.query[a] = o[a]);
                try {
                    var u = "rtmp" === f(r.url) ? h(i.format(n)) : i.format(n)
                } catch (r) {
                    return y(r, e)
                }
                return v(u, e)
            }
        }), e.exports = n.CloudFront.Signer
    }, {
        "../core": 39
    }]
}, {}, [91]);
...
AWS.apiLoader.services.iam = {}, AWS.IAM = AWS.Service.defineService("iam", ["2010-05-08"]);
