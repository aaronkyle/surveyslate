...
//Data Source: [Census Nepal, 2011](https://census
// nepal.cbs.gov.np/Home/Details?tpid=5&dcid=44c9ea09-db76-4b98-a63a-28bb2f73eabe&tfsid=1)
...
const localHouseholdLevelSheet = await FileAttachment("Local-Household-Level.xlsx").xlsx()
...
export const byProvince = data.byProvince


//## District Wise


export const byDistrict = data.byDistrict


//## Municipality Wise


export const byMuncipality = data.byLocalLevel
