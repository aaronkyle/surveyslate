# GESI Survey | Application Technical Overview
*Documentation for getting started with your own survey application & orientation to application components.*

<!--
Our GESI Self-Assessment survey application is comprised of an [assemblage of Observable web-based notebooks](#core-application-notebooks), each of which can be **forked** and customized **programmatically** using just a browser.
...
This document introduces the Survey Slate's architecture and walks through the process of deploying the application to help others implement and adapt it.  Have question or wish to help us improve?  Please feel welcome to open a comment or send a suggestion!  And thank you for your time and interest!
