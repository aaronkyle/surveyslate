...
```js
viewof listenTests = testing.createSuite()
```
...
```js
viewof docsViewTests = testing.createSuite()
```
...
```js
viewof permissionDeniedView = new DocsView(firebase.firestore().collection("hjfkjhfsd/dasdasdas/dasdasdas"))
```
